...
Notice that in the recursive method the function `recursive_sum` is called within itself, but with an input of `n-1`. What is happening here? This is the _magic_ part I mentioned.
